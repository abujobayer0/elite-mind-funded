...
export default function FeatureCard({
  ...
  return (
    <div
      className={
        "rounded-xl border p-5 md:p-6 lg:p-7 transition-all duration-300 " +
        (emphasis
          ? "border-[#f6a91b]/25 bg-gradient-to-b from-[#171511] to-[#0b0a08] shadow-[0_0_40px_rgba(246,169,27,0.06)]"
          : "border-white/10 bg-[#0f0f0f]")
      }
    >
      <div className="h-[140px] md:h-[160px] rounded-lg bg-gradient-to-b from-white/5 to-transparent flex items-center justify-center mb-5">
        {children}
      </div>
